...
person_data = ["Bob", "Bobson", "56", "Engineering", "Athens"]
...
password = input("Enter your password. Password must contain at least 8 letters or numbers, but no special characters: ")
